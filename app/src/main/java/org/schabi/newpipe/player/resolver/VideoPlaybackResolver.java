...
public class VideoPlaybackResolver implements PlaybackResolver {
    ...
    public MediaSource resolve(@NonNull final StreamInfo info) {
        ...
        appendSubtitleSources(info, mediaSources);
    ...
    private void appendSubtitleSources(@NonNull final StreamInfo info,
                                       @NonNull final List<MediaSource> mediaSources) {
        ...
        final List<SubtitlesStream> validStreams =
                getUrlAndNonTorrentStreams(subtitlesStreams);

        for (final SubtitlesStream subtitle : validStreams) {
